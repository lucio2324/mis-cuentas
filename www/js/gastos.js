...
function abrirBaseDatos() {
    db = window.openDatabase('Gasto', '1.0', 'Esto es una prueva', 10000000);
...
function validarGastos() {
    ...
    if (categoria === "") {
        ...
        db.transaction(function (tx) {
            tx.executeSql('INSERT INTO gasto h(categoria,nombre,importe,fecha,usuario) VALUES (?,?,?,?,?)', [categoria, nombre, importe, fechaCorregida, usuario]);
